        ...
        <div className="bg-gray-100 dark:bg-gray-800 pb-10">
          ...
          <div className="bg-white hidden md:block dark:bg-gray-700 w-[350px] p-5 rounded-md mt-10">
              ...
              <div className="my-5 flex flex-wrap gap-3">
                 {
                    ["Blogging" , "Web Development" , "Digital Marketing" , "Photography" , "Sports" , "Cooking"].map((item, index)=>{
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">Get the latest post and updates delivered striaght to your inbox </p>
                ...
                <ul className="space-y-3">
                  {
                    ["10 tips to master react" ,
                     ...
                     "Inprove SEO in 2 minutes " ].map((title,index)=>{
