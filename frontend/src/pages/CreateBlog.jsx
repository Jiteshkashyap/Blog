    ...
    const getSelectedCategory=(value)=>{
      ...
      const createBlogHandler=async()=>{
        try {
            ...
            const res=await axios.post("http://localhost:8000/api/v1/blog/create-blog",{title , category},{
                headers:{
    ...
    return(
        <div className="p-4 md:pr-20 h-screen md:ml-[320px] pt-20">
              <Card className="md:p-10 p-4 dark:bg-gray-800 -space-y-5">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis sunt tempore est excepturi quo non autem! Dignissimos iste blanditiis ex explicabo necessitatibus. Temporibus quis quos iusto voluptas aliquam? Similique nemo consequuntur voluptas eaque delectus vel quasi quia eum perspiciatis in, dolor placeat explicabo.!</p>
                <div className="mt-10">
                    <div>
                        <Label>Title</Label>
                        <Input type="text"
