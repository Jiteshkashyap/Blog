          ...
          <div>
            ...
            <div className="flex flex-col gap-2 items-start justify-start my-5">
              ...
              <p className="border dark:border-gray-600 p-6 rounded-lg">
                {user?.bio ||
                  "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quidem corrupti, enim voluptatibus labore exercitationem reiciendis culpa possimus iste ut debitis! Deserunt accusamus, inventore cupiditate minus quidem eum! Minima non tenetur, odio iure accusamus magni neque! "}
              </p>
            </div>
