...
import { toast } from "sonner";
 const BlogView=()=>{
    ...
    const [liked ,setLike] =useState(selectedBlog.likes.includes(user._id ) || false)
 ...
 ///creating url which have to be shared
   ...
   if(navigator.share){
    ...
    //fallback to clipboard
        navigator.clipboard.writeText(blogUrl).then(()=>{
          toast.success("Blog link copied to the clipboard")
        })
   }
    }
    ...
    <div className="mt-10">
     ...
     <Badge variant="secondary">Javacript</Badge>
     <Badge variant="secondary">Web Development</Badge>
      ...
      <div className="flex items-center justify-between border-y dark:border-gray-800 border-gray-300 py-4 mb-8">
        ...
        <div className="flex items-center space-x-2">
          ...
          <Button onClick={()=>handleShare(selectedBlog._id)} variant="ghost"><Share2  className="w-4 h-4" /></Button>
